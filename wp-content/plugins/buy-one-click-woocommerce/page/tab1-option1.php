...
<div class="buy-message-block-admin">
    ...
    <p class="text"><?php _e('Plugin add-on', 'coderun-oneclickwoo'); ?>: <a href="https://coderun.ru/product/asgaros-forum-wordpress-uvedomleniya-o-sobytiyakh-v-viber/?utm_source=buyone_plugin"><?php _e('Order notifications in your Viber', 'coderun-oneclickwoo'); ?></a></p>
