...
jQuery(document).ready(($) => {
    ...
    const previewSlider = $('.preview-slider');

    if (bannerSlider.length !== 0 && bannerSlider.children().length > 1 && previewSlider.length !== 0) {
        ...
        console.log(bannerSlider.children().length);
