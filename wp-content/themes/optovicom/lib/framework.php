...
/**
 * Various functions required for optovicom-foundation to work properly
 *
 *
 */
/*
 ...
 */
if (!class_exists('optovicom_navwalker')) :
  class optovicom_navwalker extends Walker_Nav_Menu
  {
  ...
  if (!class_exists('optovicom_mobile_navwalker')) :
    class optovicom_mobile_navwalker extends Walker_Nav_Menu
    {
      function start_lvl(&$output, $depth = 0, $args = array())
      {
        $indent = str_repeat("\t", $depth);
 ...
 */
if (!function_exists('optovicom_menu_fallback')) :
  function optovicom_menu_fallback()
  {
...
if (!function_exists('optovicom_active_nav_class')) :
  function optovicom_active_nav_class($classes, $item)
  {
  ...
  add_filter('nav_menu_css_class', 'optovicom_active_nav_class', 10, 2);
endif;

// 3 - Pagination: {@link https://codex.wordpress.org/Pagination}

if (!function_exists('optovicom_pagination')) :
  function optovicom_pagination()
  {
    global $wp_query;
 ...
 */
if (!function_exists('optovicom_active_list_pages_class')) :
  function optovicom_active_list_pages_class($input)
  {
  ...
  add_filter('wp_list_pages', 'optovicom_active_list_pages_class', 10, 2);
endif;

// 4 - Comments tree: @link {https://codex.wordpress.org/Function_Reference/Walker_Comment}

if (!class_exists('optovicom_Comments')) :
  class optovicom_Comments extends Walker_Comment
  {
    ...
    { ?>
      ...
      <h3><?php comments_number(__('No Responses to', THEME_TD), __('One Response to', THEME_TD), __('% Responses to', THEME_TD)); ?>
        &#8220;<?php the_title(); ?>&#8221;</h3>
      ...
      <header class="comment-author">
        ...
        <div class="author-meta vcard author">
          ...
          <time datetime="<?php echo comment_date('c') ?>"><a
                href="<?php echo esc_url(get_comment_link($comment->comment_ID)) ?>"><?php printf(__('%1$s', THEME_TD), get_comment_date(), get_comment_time()) ?></a>
          </time>
