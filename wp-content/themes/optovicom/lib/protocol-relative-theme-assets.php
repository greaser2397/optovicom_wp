...
if (!class_exists('Optovicom_Protocol_Relative_Theme_Assets')) :

  class Optovicom_Protocol_Relative_Theme_Assets
  {
    /**
  ...
  $optovicom_protocol_relative_theme_assets = new Optovicom_Protocol_Relative_Theme_Assets;
