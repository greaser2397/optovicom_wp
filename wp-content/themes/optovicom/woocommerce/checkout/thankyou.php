...
<div class="woocommerce-order">
    ...
    <?php if ($order) : ?>
        ...
        <?php if ($order->has_status('failed')) : ?>
            ...
            <div class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions link-wrapper">
        ...
        <?php else : ?>
            ...
            <div class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received-actions link-wrapper">
