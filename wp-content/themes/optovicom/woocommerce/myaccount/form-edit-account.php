...
<h2 class="account-page__title"><?= esc_html__('Личная информация', 'woocommerce'); ?></h2>
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
  ...
  <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row-half">
