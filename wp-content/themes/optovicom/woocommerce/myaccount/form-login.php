...
<div class="u-columns col2-set" id="customer_login">
  ...
  <div class="u-column1 col-1">
    ...
    <form class="woocommerce-form woocommerce-form-login login" method="post">
      ...
      <p class="form-row form-row-footer">
      ...
      <div class="register-notice-wrapper">
        <p><?= esc_html__('Не зарегистрированы? ', 'woocommerce'); ?></p>
        <a href="<?= get_permalink(get_page_by_path('register')); ?>" class="register__link">
            <?= esc_html__('Зарегистрироваться', 'woocommerce'); ?>
        </a>
      </div>
